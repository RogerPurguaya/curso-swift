...
/*class TableViewCellNuevo: UITableViewCell{
    ...
    @IBOutlet weak var imagenNumero: UIImageView!
...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case "1"?:
            ...
            cell.detailTextLabel?.text = "Imagen 1"
        case "2"?:
            cell.imageView?.image = UIImage(named: "2.png")
            cell.detailTextLabel?.text = "Imagen 2"
        case "3"?:
            cell.imageView?.image = UIImage(named: "3.png")
            cell.detailTextLabel?.text = "Imagen 2"
        default:
            cell.detailTextLabel?.text = "Solo número"
