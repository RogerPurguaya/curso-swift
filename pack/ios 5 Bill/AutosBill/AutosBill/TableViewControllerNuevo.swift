...
class TableViewControllerNuevo: UITableViewController {
    ...
    var arregloNumeros: [String] = ["1","2","3","4","5"]
    var nombreNumRecibido:String?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case "1"?:
            ...
            cell.detailTextLabel?.text = "Auto Super Veloz"
        case "2"?:
            cell.imageView?.image = UIImage(named: "2.jpg")
            cell.detailTextLabel?.text = "Auto blanco Mercedes Beans"
        case "3"?:
            cell.imageView?.image = UIImage(named: "3.jpg")
            cell.detailTextLabel?.text = "Auto deportivo 2015 chebrole"
        case "6"?:
            cell.imageView?.image = UIImage(named: "6.jpg")
            cell.detailTextLabel?.text = "Nuevo auto diseño 2018"
        default:
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
           ...
           // arregloNumeros.insert(elemt!, at: indexPath.row
         arregloNumeros.insert("200", at: arregloNumeros.endIndex)
            tableView.reloadData()
        }    
    }
