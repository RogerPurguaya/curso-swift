...
//  TableViewControllerBill
//
//  Created by MAC01 on 9/04/18.
...
class TableViewControllerNuevo: UITableViewController {
    ...
    var arregloNumeros: [String] = ["1","2","3","4","5","6","6","9","9"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case"1"?:
            ...
            cell.detailTextLabel?.text = "Numero1"
        case"2"?:
            cell.imageView?.image = UIImage(named: "2.png")
            cell.detailTextLabel?.text = "Numero2"
        case"3"?:
            cell.imageView?.image = UIImage(named: "3.png")
            cell.detailTextLabel?.text = "Numero3"
        case"4"?:
            cell.imageView?.image = UIImage(named: "4.png")
            cell.detailTextLabel?.text = "Numero4"
        default:
            cell.detailTextLabel?.text = "Solo numero :p"
        }
        return cell
    }
    ...
    override func tableView(_ tableView: UITableView, moveRowAt fromIndexPath: IndexPath, to: IndexPath) {
        let objectMovido = self.arregloNumeros[fromIndexPath.row]
        arregloNumeros.remove(at: fromIndexPath.row)
        arregloNumeros.insert(objectMovido, at: to.row)
